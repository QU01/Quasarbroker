...
export default function TopRightControls() {
    ...
    const checkForUpdates = async () => {
        ...
        try {
            const res = await fetch("https://api.github.com/repos/BigBodyCobain/Quasarbroker/releases/latest");
        ...
        <div className="absolute top-full right-0 mt-2 w-72 z-[9999]">
            <div className="bg-[var(--bg-primary)]/95 backdrop-blur-md border border-cyan-800/60 rounded-lg shadow-[0_4px_30px_rgba(0,255,255,0.15)] overflow-hidden">
                ...
                <div className="p-3 flex flex-col gap-2">
                    ...
                    <a
                        href="https://github.com/BigBodyCobain/Quasarbroker/releases/latest"
                        target="_blank"
                        rel="noreferrer"
    ...
    return (
        <div className="relative flex items-center gap-2 mb-1 justify-end">
            {/* Discussions link */}
            <a
                href="https://github.com/BigBodyCobain/Quasarbroker/discussions"
                target="_blank"
                rel="noreferrer"
